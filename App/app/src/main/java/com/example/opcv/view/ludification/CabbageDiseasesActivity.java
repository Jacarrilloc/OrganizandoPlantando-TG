...
public class CabbageDiseasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cabbage_diseases);
        ...
        ludification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isOnline()){
                    Intent edit = new Intent(CabbageDiseasesActivity.this, DictionaryHomeActivity.class);
                    startActivity(edit);
                }
                else{
                    Toast.makeText(CabbageDiseasesActivity.this, "Para acceder necesitas conexión a internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        myGardens.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CabbageDiseasesActivity.this, GardensAvailableActivity.class));
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent edit = new Intent(CabbageDiseasesActivity.this, EditUserActivity.class);
        ...
        rewards.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CabbageDiseasesActivity.this, RewardHomeActivity.class));
            }
        });
