...
public class CorianderDiseaseActivity extends AppCompatActivity {
    ...
    private TextView textView, corianderReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        corianderReference = (TextView) findViewById(R.id.textView34);

        Linkify.addLinks(corianderReference, Linkify.WEB_URLS);
