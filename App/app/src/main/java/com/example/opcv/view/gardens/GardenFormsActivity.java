...
import com.example.opcv.view.adapter.FormsListAdapter;
...
import com.example.opcv.view.forms.FormsRegistersActivity;
...
public class GardenFormsActivity extends AppCompatActivity {
                ...
                if(Objects.equals(register_forms, "Forms")){
                    switch (i){
                        case 0:{
                            ...
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_RAC.class);
                        ...
                        case 1:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_RE.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 2:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_IMP.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 3:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_SCMPH.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 4:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_RSMP.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 5:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_CPS.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 6:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_RCC.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 7:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_RRH.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 8:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_CIH.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
                        ...
                        case 9:{
                            Object selectedItem = adapterView.getItemAtPosition(i);
                            String formsName = selectedItem.toString();
                            Intent newForm = new Intent(GardenFormsActivity.this, Form_RHC.class);
                            newForm.putExtra("Name",formsName);
                            newForm.putExtra("idGardenFirebase",idGardenFirebase);
                            newForm.putExtra("watch","create");
                            startActivity(newForm);
